...
-- Kỷ niệm 2/9 & 30/4 với nhạc + pháo hoa
...
-- ===== HỘP NHẬP NHẠC =====
local function nhapID(callback)
    local inputFrame = Instance.new("Frame", ScreenGui)
    inputFrame.Size = UDim2.new(0.4,0,0.2,0)
    inputFrame.Position = UDim2.new(0.3,0,0.4,0)
    inputFrame.BackgroundColor3 = Color3.fromRGB(30,30,30)

    local box = Instance.new("TextBox", inputFrame)
    box.Size = UDim2.new(0.8,0,0.4,0)
    box.Position = UDim2.new(0.1,0,0.1,0)
    box.PlaceholderText = "Nhập ID nhạc Roblox..."
    box.TextScaled = true
    box.ClearTextOnFocus = false

    local ok = Instance.new("TextButton", inputFrame)
    ok.Size = UDim2.new(0.5,0,0.3,0)
    ok.Position = UDim2.new(0.25,0,0.6,0)
    ok.Text = "OK"
    ok.TextScaled = true
